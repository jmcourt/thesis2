...
#    	immediate help:   type "help"  (plot window: hit 'h')
 set terminal postscri enhance color 14
 set output "test.ps"
unset clip points
set clip one
unset clip two
...
a = 24500
b = 3100
plot [0:b][10:50]"2014/16605_lc_heg_meg_10s.asc" u ($1-5.125064320739100E+08-a):2:3 w filledc x1 lc rgb "grey","2014/16605_lc_heg_meg_10s.asc" u ($1-5.125064320739100E+08-a):2:3 w yerrorl ps 1 pt 7 lt 1 lc rgb "black"
#    EOF
